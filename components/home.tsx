  ...
  return (
    <section className="hero-a" style={{ background: 'var(--color-surface)', borderRadius: 28 }}>
      <div className="hero-left" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 9, alignSelf: 'flex-start', fontSize: 11, fontWeight: 600, letterSpacing: '.06em', textTransform: 'uppercase', color: 'var(--color-gold-700)', background: 'var(--color-gold-100)', padding: '7px 14px', borderRadius: 999, marginBottom: 24 }}><span style={{ fontWeight: 800 }}>Mastercut</span> precision cutting tools · factory direct</div>
        <h1 style={{ lineHeight: 1.0, letterSpacing: '-.03em', fontWeight: 800, margin: '0 0 20px', color: 'var(--color-text)', textShadow: '-1px -1px 0 rgba(255,255,255,.6), 2px 3px 0 var(--color-accent-800)' }}>American-Made.<br />Built for <span style={{ color: 'var(--color-accent)', textShadow: '-1px -1px 0 rgba(255,255,255,.6), 2px 3px 0 var(--color-accent-800), 0 0 24px rgba(191,155,48,.55)', WebkitTextStroke: '0.6px var(--color-gold-2)' }}>Precision</span><span style={{ color: 'var(--color-gold-2)' }}>.</span></h1>
