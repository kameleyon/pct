  ...
  return (
    <section className="hero-a" style={{ background: 'var(--color-surface)', borderRadius: 28 }}>
      <div className="hero-left" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        ...
        <h1 style={{ lineHeight: 1.0, letterSpacing: '-.03em', fontWeight: 800, margin: '0 0 20px', color: 'var(--color-text)', textShadow: '-1px -1px 0 rgba(255,255,255,.6), 2px 3px 0 var(--color-accent-800)' }}>American-Made.<br />Built for <span style={{ color: 'var(--color-accent)', textShadow: '-1px -1px 0 rgba(255,255,255,.6), 2px 3px 0 var(--color-accent-800), 0 0 24px rgba(191,155,48,.55)' }}>Precision</span>.</h1>
